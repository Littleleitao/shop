<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"F:\phpStudy\PHPTutorial\WWW\tp5\public/../application/admin\view\auth\upd.html";i:1533817792;}*/ ?>
...
<body>
    ...
    <div class="formbody">
        ...
        <form action="" method="post">
            <!-- 隐藏域 -->
            <input type="hidden" name="auth_id"  value="<?php echo $auth['auth_id']; ?>"/>
            <ul class="forminfo">
                <li>
                    <label>权限名称</label>
                    <input name="auth_name" value="<?php echo $auth['auth_name']; ?>" placeholder="请输入权限名称" type="text" class="dfinput" /><i></i>
                </li>
                <li>
                    <label>父级权限</label>
                ...
                <li>
                    <label>控制器名<?php echo $auth['auth_c']; ?></label>
